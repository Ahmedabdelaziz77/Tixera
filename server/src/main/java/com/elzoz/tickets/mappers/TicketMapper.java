...
import com.elzoz.tickets.domain.dtos.ListTicketResponseTicketTypeDto;
...
public interface TicketMapper {
    ...
    ListTicketResponseTicketTypeDto toListTicketTicketTypeResponseDto(TicketType ticketType);
